...
export default function UserNFTDetails(tokenStandard) {
  ...
  console.log(Networks[1].blockExplorerUrl[0]);
  ...
  }, [curentPage,tokenStandard]);
// const recheckToken=(chainId,txHash)=>{

//   let netObj=chainId!=0 && Networks[chainId];
//   let urltemp=netObj && netObj.blockExplorerUrl[0]+"tx/"+txHash;
                  ...
                  {data.map((val, key) => {
                    return (
                      <div key={key} className='shadow rounded-lg bg-white m-4 p-4 cursor-pointer hover:-translate-y-1 hover:scale-110 duration-300'>
                        ...
                        <LabelValue label='Token Name' val={val.tokenName} />
                        <LabelValue label='Token Symbol' val={val.tokenSymbol} />
                        <LabelValue label='Public Mint' val={val.isPublicMint} />
                        <LabelValue label='Start Time' val={val.startTime} />
                        <LabelValue label='End Time' val={val.endTime} />
                        ...
                        <div className='flex flex-row'>
                          ...
                          <p>:</p>
                          {val.status == 'Deployed' && <a target="_blank" className='w-1/2 pl-2 pt-2' href={Networks[val.chainId].blockExplorerUrls[0] +"/tx/"+ val.txHash}>
                  ...
                  <table className='w-full'>
                    <thead>
                      <tr className='shadow'>
                        ...
                        <th className='userth font-medium'>Token Symbol</th>
                        <th className='userth font-medium'>Public Mint</th>
                        <th className='userth font-medium'>Start Time</th>
                        <th className='userth font-medium'>End Time</th>
                      ...
                      return (
                        <tbody className='rotate-45' key={key}>
                          <tr className='shadow hover:bg-gray-50 '>
                            ...
                            <td className='usertd'>{val.tokenSymbol}</td>
                            {/* <td className='usertd'> { JSON.stringify(val.chainId !="0" ? Networks[val.chainId].blockExplorerUrls:Networks[val.chainId]  )}</td> */}
                            <td className='usertd'>{val.isPublicMint?"Mint":"Not Mint"}</td>
                            <td className='usertd'>{val.startTime}</td>
                            <td className='usertd'>{val.endTime}</td>
