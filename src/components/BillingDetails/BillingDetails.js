    ...
    return (
        <form className="w-full flex flex-col md:flex-row">
            ...
            <div className="w-full md:w-1/2 mt-5 mr-3 bg-white rounded-lg border border-gray-200 shadow-md p-2 sm:p-4 lg:p-6 dark:bg-gray-800 dark:border-gray-700 ">
                ...
                <div className='mb-2'>
                    <label for="emailid" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Email Id<span className="text-red-600">*</span></label>
                    <input
                        type="text"
                        name="emailid"
                        id="emailid"
                ...
                <div className='mb-2'>
                    <label for="state" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"> State <span className="text-red-600">*</span></label>
                    <input
                        type="text"
                        name="state"
                        id="state"
                ...
                <div className='mb-2'>
                    <label for="taxId" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Tax ID Code <span className="text-red-600">*</span></label>
                    <input
                        type="text"
                        name="taxId"
                        id="taxId"
                    ...
                    {submitted && formError.taxId && (
                        <div className="block mb-2 text-sm font-medium text-red-900 dark:text-red-300">{formError.taxId} <span className="text-red-600">*</span></div>
                    )}
                </div>
            </div>
            ...
            <div className="w-full md:w-1/2 mt-5 bg-white rounded-lg border border-gray-200 shadow-md p-2 sm:p-4 lg:p-6 dark:bg-gray-800 dark:border-gray-700">
                ...
                <div className='mb-2'>
                    ...
                    {submitted && formError.legalName && (
                        <div className="block mb-2 text-sm font-medium text-red-900 dark:text-red-300">{formError.legalName} <span className="text-red-600">*</span></div>
                    )}
                </div>
                <div className='mb-2'>
                    <label for="zipCode" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Zip/Postal Code<span className="text-red-600">*</span></label>
                    <input
                        type="text"
                        name="zipCode"
                        id="zipCode"
                    ...
                    {submitted && formError.zipCode && (
                        <div className="block mb-2 text-sm font-medium text-red-900 dark:text-red-300">{formError.zipCode} <span className="text-red-600">*</span></div>
                    )}
                </div>
                ...
                <div className='mb-2'>
                    <label for="city" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"> City<span className="text-red-600">*</span></label>
                    <input
                        type="text"
                        name="city"
                        id="city"
                ...
                <div className='mb-2'>
                    <label for="taxRegNumber" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"> VAT or Tax Registration Number<span className="text-red-600">*</span></label>
                    <input
                        type="text"
                        name="taxRegNumber"
                        id="taxRegNumber"
