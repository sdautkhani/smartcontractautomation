            ...
            complete: function (results) {
                ...
                if (Object.keys(results.data).length > 0) {
                    ...
                    results.data.map((d,i) => {
                        ...
                        dataupload +=(i+1).toString()+" "+tokenValues.join(",")+"\n";
                ...
                {(tokenAddress != "" && tokenerror == "") && <div className="intro-x text-center xl:text-left">
                    ...
                    <div>
                        ...
                        <NumberedTextArea  setTokenList={setTokenList} 
                                note='Insert one address and the respective amount per line. Separate the address and amount with a comma and no space in between.

                                Please NOTE: tokens will be sent to batches of 200 addresses. If there are more than 200 addresses in your list, you will have to approve each batch separately.'
                                tokenStandard="ERC20" uploadedData={uploadedData} setError={seterrormsg}/>
