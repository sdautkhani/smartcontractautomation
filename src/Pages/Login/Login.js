...
export default function Login() {
    ...
    return (
        <>
            {!showLogin ?
                <div className="w-full sm:w-1/2 my-6 p-2 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md lg:p-8 mx-auto">
                    <h2 className="text-center  font-bold text-xl text-yellow-600">Automator</h2>
