    ...
    return (
        <div className='bg-blue-50'>
            <div className='bg-white p-4 flex flex-row justify-between items-center'>
                <div className='flex flex-col md:flex-row items-start md:items-center px-2 md:px-4 pt-4 pb-3 cursor-pointer'>
            ...
            <div className='bg-white p-4 grid grid-row md:grid-cols-2'>
                <div className='md:col-span-1 flex justify-center p-16'>
                    <p className='text-lg font-medium'>
                        ...
                        Deploy it on your preferred EVM compatible blockchain such as Ethereum, Avalanche and Binance Smart Chain. Sign up or Login with MetaMask.
            ...
            <div className='my-4 p-4'>
                ...
                <div className='grid grid-cols-2 md:grid-cols-4'>
                    {data.map((obj, k) => (
                        <div key={k} className='shadow rounded-lg bg-white m-4 p-4 hover:scale-105'>
